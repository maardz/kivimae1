   ...
   <?php include "header.php"; ?>
    ...
    <div class="container">
      ...
      <div class="starter-template">
        <h1>Arvuta toote hind</h1>
        
        <form action = "calc.php" method = "post">
      <div class="form-field">
        <input type="text" name="paksus" placeholder="Paksus">
      </div>

      <div class="form-field">
        <input type="text" name="laius" placeholder="Laius">
        
      </div>

      <div class="form-field">
        <input type="text" name="pikkus" placeholder="Pikkus">
      </div>

      <div class="form-field">
        <input type="text" name="hind" placeholder="Hind">
      </div>
